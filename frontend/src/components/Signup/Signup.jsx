        ...
        <div className="col-12 col-sm-8 col-md-6 m-auto">
          <div className="card p-4" id='card-Signup'>
            <div className="card-body" id='cardBody-Signup'>
              ...
              <h1><span id='span-signup'>R</span>EGISTER</h1>
              </div>
              <form action="">
                ...
                Sex:
                <input type="radio"  name='radio' id='option1'/><label id='label-signup' htmlFor="option1" style={{margin:'0px 8px'}}>Male</label>
                <input type="radio"  name='radio' id='option2'/><label id='label-signup' htmlFor="option2" style={{margin:'0px 8px'}}>Female</label>
                <input type="radio"  name='radio' id='option3' /><label id='label-signup' htmlFor="option3" style={{margin:'0px 8px'}}>Other</label>             
                </div>
                ...
                <div className="subContainer text-center">
                  ...
                  <p><span id='span-signup'>Already have an account?</span><Link to="/login"id='link-Login'>Login here</Link></p>                 
                </div>
              </form>
            </div>
          </div>
